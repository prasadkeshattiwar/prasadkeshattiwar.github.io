...
<br>
	...
	<tr>
		...
		<td><font color="#7c0000"><b><i></i></b></font><center>
		  <font color="#7c0000"><b><i>HOTEL IN NAVAI MUMBAI:HOTEL PRASAD
		</i></b></font>
		</center></td>
	</tr>
	<tr>
		...
		<td><font color=chocolate>		
						Hotel PRASAD,among the premier
		business hotel in
						NAVI MUMBAI the economic capital of
		MAHARASHTRA is 			
						characterised by the traditionally
		hospitality located
						in the heart of the city.The ideal
		choice amongs hotels
						in NAVI MUMBAI for businessman and
		tourist.</font></td>
	...
	<tr>
		...
		<td><font color=darkpink>
					The PRASAD offers facilities that no 
		other NAVI MUMBAI hotels
	...
	<table>
		<tr>
			...
			<td><font color=chocolate>
			The only one Navi Mumbai hotels having all facilities a business center,beauty parlor,health club,gym,saloon,
			boutique,internet cafe,pastry shop,travel desk and money exchange the PRASAD hotels given you full value
			for money.</font></td>
		...
		<td></td>
		<td><font color=darkpink>
		Hotel PRASAD takes pride in being a host to a number of celebrities,including bollywood and telewood starts,
		cricketers,political leaders as well as corporate borons and also being the most prefered in MUMBAI.By the NRIs.
		<td></td>
		</tr>
	</table>
    <marquee behavior=alternate bgcolor="#7e0000"><b><i><a href=contectus.php><font color="white">Devloped By :- Prasad - Akshata - Shraddha </a></i></b></font></marquee>
</body>
</html>
